package com.jtsoft.letmedo.common.pay.alipay;
...
public class Alipay {
    ...
    public static final int ERROR_RESULT = 0x1001;   //支付结果解析错误
    public static final int ERROR_PAY = 0x1002;  //支付失败
    public static final int ERROR_NETWORK = 0x1003;  //网络连接错误
    ...
    public Alipay(Context context, String appRequest, AlipayResultCallBack callback) {
        mParams = appRequest;
        mCallback = callback;
