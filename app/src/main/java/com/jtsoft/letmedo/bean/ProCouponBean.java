...
public class ProCouponBean {
    ...
    private OutTimeBean.ResponseBean response;
    ...
    public OutTimeBean.ResponseBean getResponse() {
        return response;
    }

    public void setResponse(OutTimeBean.ResponseBean response) {
    ...
    public static class ResponseBean {
        ...
        public List<OutTimeBean.ResponseBean.CouponListBean> getCouponList() {
            return couponList;
        }

        public void setCouponList(List<OutTimeBean.ResponseBean.CouponListBean> couponList) {
